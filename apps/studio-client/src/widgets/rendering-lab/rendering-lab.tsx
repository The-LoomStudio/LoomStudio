    ...
    <div className={styles.renderingLab}>
      ...
      <section className={styles.renderingLabResult}>
        ...
        {props.mode === 'new-tab' ? (
          ...
          <div className={styles.renderingLabSurface} data-loom-render-surface={props.sample.surface}>
...
function RenderDisplayPart(props: {
  ...
  if (props.part.type === 'agent-action') {
    return (
      <div className={styles.agentChoiceCard} data-loom-component="agent-action-card">
  ...
  return (
    <figure className={styles.inlineArtifact} data-loom-artifact={props.part.artifactType}>
