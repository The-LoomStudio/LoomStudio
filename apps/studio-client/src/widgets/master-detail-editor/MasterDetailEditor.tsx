import styles from './MasterDetailEditor.module.css'
...
export function MasterDetailEditor(props: MasterDetailEditorProps) {
  ...
  return (
    <section className={styles.shell} data-airp-component="master-detail-editor">
      <aside className={styles.treePane} data-airp-component="master-tree">
      ...
      <section className={styles.detailStage} data-airp-component="detail-stage">
        <div className={styles.editorColumn} data-airp-component="detail-editor">
