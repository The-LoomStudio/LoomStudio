...
export function FileTree(props: FileTreeProps) {
  ...
  return (
    <DndContext onDragEnd={handleDragEnd} onDragStart={handleDragStart}>
      <div className={styles.tree} role="tree" aria-label={props.ariaLabel} data-airp-component="file-tree">
    ...
    <>
      {props.node.isSection ? (
        ...
        <div
          ref={setDroppableRef}
          className={rowClass}
          style={{ '--airp-tree-level': props.level } as CSSProperties}
          role="treeitem"
        >
          <div
            ref={setDraggableRef}
...
function readDropPosition(nodes: FileTreeNode[], draggedId: string, overId: string): 'before' | 'after' {
