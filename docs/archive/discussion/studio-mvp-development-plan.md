...
> **Status**: Archived / MVP Stage 0—5 Complete
> **Archived**: 2026-08-28；验收记录见 [`mvp-stage-notes/stage-5.md`](../mvp-stage-notes/stage-5.md)，本文不再作为施工入口。
...
- Manifest 是否符合 [`../05-extensions/studio-extension-manifest-architecture.md`](extensions/studio-extension-manifest-architecture.md)；
- Lifecycle 是否符合 [`../05-extensions/studio-extension-lifecycle-v0.md`](extensions/studio-extension-lifecycle-v0.md)；
- `contributes` 是否在顶层；
