...
> **Status**: Archived / Superseded Repository Blueprint
> **Archived**: 2026-08-28；当前仓库结构见 [`docs/guide/project-structure.md`](../../guide/project-structure.md)。
...
> **2026-08-15 路径替代说明**：本文中的 `.loomstudio-dev/projects/<project-id>`、workspace-local Extension scratch 与 per-project runtime 目录属于早期工程草图，不再作为后续实现依据。本地结构化数据、Blob、Extension、Cache 与 Log 路径统一见 [`../plans/local-data-blob-store-foundation-plan.md`](../../archive/plans/local-data-blob-store-foundation-plan.md)。
> **Related**:
>
