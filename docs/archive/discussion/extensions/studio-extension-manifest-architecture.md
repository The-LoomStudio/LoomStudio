...
> **Status**: Archived / Superseded by Manifest v2
> **Archived**: 2026-08-28；当前 Package / Module / Instance 与 Manifest v2 见 [`docs/architecture/extensions/`](../../../architecture/extensions/)。
