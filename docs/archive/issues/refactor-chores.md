...
> **当前入口**：Application Runtime 拆分见 [`application-runtime-modularization-plan.md`](../plans/application-runtime-modularization-plan.md)；Extension / Event 后续见当前 Extension Plans 与 Discussion。
