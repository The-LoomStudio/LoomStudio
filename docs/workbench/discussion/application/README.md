...
| [`../../../archive/plans/renderer-surface-and-client-host-implementation-plan.md`](../../../archive/plans/renderer-surface-and-client-host-implementation-plan.md) | Implemented / Audited | Renderer Surface、冲突仲裁、Client Extension Host 与动态实例生命周期 |
