...
2. ADR：理解已接受决策；
3. Kernel / Protocol：锁定 Kernel public surface 与 RPC；
4. Data：锁定 Document Store / rollback / trace-audit；
5. Extensions：锁定 Manifest / activation / registration；
6. Engineering：锁定 MVP 阶段门控计划、仓库骨架、依赖、package API 与 local state。
